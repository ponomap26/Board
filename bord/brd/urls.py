...
from .views import BlogsList, BlogsDetail, BlogsSearch, BlogsCreate, BlogsUpdate, BlogsDelete, add_response, ResponseList
...
urlpatterns = [
    ...
    path('<int:pk>/response/respons_list/', ResponseList.as_view(), name='response_list'),
